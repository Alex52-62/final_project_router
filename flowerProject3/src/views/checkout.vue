<template>
                <div id="content" class="right">
                    ...
                    <div class="content_half left form_field">
                        ...
                        <input name="fullname" type="text" id="fullname" maxlength="40" /> Address:
                        <input name="address" type="text" id="address" maxlength="40" /> City:
                        <input name="city" type="text" id="city" maxlength="40" /> Country:
                        <input name="country" type="text" id="country" maxlength="40" />
                    </div>

                    <div class="content_half right form_field">
                        Email:
                        <input name="email" type="text" id="email" maxlength="40" /> Phone:
                        <br />
                    ...
                    <p>
                        <a href="#">
                            <img src="@/assets/images/paypal-straight.png" alt="paypal" align="middle" />
                            </a>&nbsp;(recommended if you have a PayPal account. Fastest way to complete your order.)
                    </p>
                    <p>
                        <a href="#">
                            <img src="@/assets/images/flag_ship.jpg" alt="Flagship" align="middle" />
                        </a>&nbsp;(free shipping for orders above $500)
                    </p>
